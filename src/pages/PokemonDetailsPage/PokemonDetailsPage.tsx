...
export const PokemonDetailsPage: React.FC = () => {
  ...
  return (
    <Container fluid="sm" className="py-4">
      <div className="d-flex mb-4 align-items-center">
        ...
        <ButtonGroup className="ms-3" aria-label="Compare toggle group">
          <ToggleButton
            ...
            aria-label={isInCompare ? `Remove ${name} from comparison` : `Add ${name} to comparison`}
      ...
      <Row>
        <PokemonHeader name={pokemon.name} spriteUrl={pokemon.sprites.front_default} types={pokemon.types} />
        <Col xs={12} md={4}>
